...
from xenonpy.contrib.ismd.reactant_pool import NotSquareError, SimPoolnotmatchError



def test_reactantpool_sim_shape():

    reactant_pool = pd.DataFrame({"id":[0,1,2,3,4], 
                                  "SMILES":["O=C(Cl)Oc1ccc(Cc2ccc(C(F)(F)F)cc2)cc1",
