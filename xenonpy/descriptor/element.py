...
class ElementDesc(BaseEstimator, TransformerMixin):
    ...
    Calculate elemental descriptors from compound's composition. i.e:
        ...
        >>> from xenonpy import ElementDesc
        >>> Desc = ElementDesc()
    ...
    def __init__(self,
        ...
        :param elements: elements information in `pandas.DataFrame` object. indexed by element symbol
        :type elements: pandas.DataFrame
        :param str comps_col: ``composition`` .
        :param bool verbose: If verbose output.
        """
        ...
        if elements:
            ...
            self.elems = pd.read_csv(csv_path, index_col='symbol')
